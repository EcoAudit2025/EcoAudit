...
class User(Base):
    ...
    total_points = Column(Float, default=0.0)  # Total points earned (supports decimals and negatives)
...
def calculate_sustainability_points(water_gallons, electricity_kwh, gas_cubic_m):
    ...
    # Convert to 0-10 point scale with decimal support and potential negative values
    if combined_score >= 95:
        return 10.0    # Perfect performance
    elif combined_score >= 90:
        return 9.5     # Outstanding combined performance
    elif combined_score >= 85:
        return 9.0     # Excellent performance
    elif combined_score >= 80:
        return 8.5     # Very good performance
    elif combined_score >= 75:
        return 8.0     # Good performance
    elif combined_score >= 70:
        return 7.5     # Above average performance
    elif combined_score >= 65:
        return 7.0     # Average performance
    elif combined_score >= 60:
        return 6.5     # Below average performance
    elif combined_score >= 55:
        return 6.0     # Poor performance
    elif combined_score >= 50:
        return 5.5     # Very poor performance
    elif combined_score >= 40:
        return 5.0     # Bad performance
    elif combined_score >= 30:
        return 3.0     # Very bad performance
    elif combined_score >= 20:
        return 1.0     # Extremely poor performance
    elif combined_score >= 10:
        return -1.0    # Wasteful usage patterns
    elif combined_score >= 5:
        return -3.0    # Highly wasteful usage
    else:
        return -5.0    # Extremely wasteful usage
